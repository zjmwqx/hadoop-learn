...
public class CustomInputFormatDemo extends Configured implements Tool {
	enum Counter
	{
		LINESKIP
	}
	public static class Map extends Mapper<LongWritable, LogWritable, Text, Text>
	{
		public void map(LongWritable key, LogWritable value, Context context) throws IOException, InterruptedException
		{
			...
			try
			{
				context.write(value.getIp(), value.getRequest());	
			}
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(conf, "CustomInputFormatDemo");								//任务名
		job.setJarByClass(CustomInputFormatDemo.class);								//指定Class
	...
	public static void main(String[] args) throws Exception 
	{
		...
		//运行任务
		int res = ToolRunner.run(new Configuration(), new CustomInputFormatDemo(), args);
