...
public class MapOnly extends Configured implements Tool {	
	...
	public int run(String[] args) throws Exception 
	{
		...
		Job job = new Job(conf, "MapOnly");								//任务名
		job.setJarByClass(MapOnly.class);								//指定Class
	...
	public static void main(String[] args) throws Exception 
	{
		...
		if ( args.length != 2 )
		{
			...
			System.err.println("Example: hadoop jar ~/Test_1.jar hdfs://localhost:9000/home/grid/Test1 hdfs://localhost:9000/home/grid/output");
