...
public class LogMapRed extends Configured implements Tool{
	enum Counter
	{
		LINESKIP
	}
	public static class Map extends Mapper<LongWritable, Text, LogWritable, Text>
	{
	...
	public static class Reduce extends Reducer<Text, LogWritable, Text, IntWritable>
	{
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(LogMapRed.class);								//指定Class
	...
	public static void main(String[] args) throws Exception 
	{
		...
		//运行任务
		int res = ToolRunner.run(new Configuration(), new LogMapRed(), args);
