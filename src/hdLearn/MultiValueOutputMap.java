...
public class MultiValueOutputMap extends Configured implements Tool {
	enum Counter
	{
		LINESKIP
	}
	public static class Map extends Mapper<Object, Text, Text, MultivalueWritable>
	{
		//only for context.write to stream,
		private Text userHostText = new Text();
		private Text requestText = new Text();
		private IntWritable responseSize = new IntWritable();
		//Object can take place, because this key is seldom used
	...
	public static class Reduce extends Reducer<Text, MultivalueWritable, Text, Text>
	{
	...
	public int run(String[] args) throws Exception {
		...
		Job job = new Job(conf, "LogProcess");								//任务名
		job.setJarByClass(MultiValueOutputMap.class);								//指定Class
	...
	public static void main(String[] args) throws Exception 
	{
		...
		//运行任务
		int res = ToolRunner.run(new Configuration(), new MultiValueOutputMap(), args);
