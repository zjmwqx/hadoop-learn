...
public class ConfPassParameter  extends Configured implements Tool {	
	...
	public int run(String[] args) throws Exception 
	{
		...
		Job job = new Job(conf, "ConfPassParameter");							//任务名
		job.setJarByClass(ConfPassParameter.class);							//指定Class
	...
	public static void main(String[] args) throws Exception 
	{
		...
		//运行任务
		int res = ToolRunner.run(new Configuration(), new ConfPassParameter(), args);
